...
const Header = () => {
    return (
        <div className='header-container grid grid-cols-2 md:mx-[100px]'>
            <div className='grid content-center pt-24'>
                <h1 className='text-6xl font-extrabold leading-[70px]'>One Step <br />
                Closer to your <br />
                <span className='text-[#8F7DFF]'>Dream Job</span></h1>
